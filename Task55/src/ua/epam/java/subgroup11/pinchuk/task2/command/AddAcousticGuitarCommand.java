...
public class AddAcousticGuitarCommand extends Command {
	...
	public void execute(Service service, Inputter inputter) {
		...
		AcousticGuitar object = (AcousticGuitar) AcousticGuitarImpl.newInstance(new AcousticGuitarImpl());
		...
		try {
			...
			System.out.println(object.getSoundHoleSize());
			System.out.println(object.getStringsCount());
