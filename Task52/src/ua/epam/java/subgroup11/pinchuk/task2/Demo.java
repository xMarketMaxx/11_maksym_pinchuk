...
public class Demo {
	...
	public static void showMenu() {
		...
		System.out.println("10.add new electic guitar");
		System.out.println("11.add new synthesizer");
	}

	public static Inputter getInputterType() {
	...
	public static void main(String[] args) throws IOException {
		//inputter type
		Inputter inputter = getInputterType();
		//locale type
		...
		while (true) {
			showMenu();
			command = utilInputter.getString("Введите команду: ");
			CommandContainer.getCommand(command).execute(service, inputter);
		}
